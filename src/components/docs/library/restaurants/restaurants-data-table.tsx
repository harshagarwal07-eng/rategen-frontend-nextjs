...
interface RestaurantsDataTableProps extends React.ComponentProps<"div"> {
  table: TanstackTable<IRestaurant>;
  actionBar?: React.ReactNode;
  loading?: boolean;
}

export function RestaurantsDataTable({ table, actionBar, children, loading = false }: RestaurantsDataTableProps) {
  return (
