...
interface VehiclesDataTableProps extends React.ComponentProps<"div"> {
  table: TanstackTable<IVehicle>;
  actionBar?: React.ReactNode;
  loading?: boolean;
}

export function VehiclesDataTable({ table, actionBar, children, loading = false }: VehiclesDataTableProps) {
  return (
