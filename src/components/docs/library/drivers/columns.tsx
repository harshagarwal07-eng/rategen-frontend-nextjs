...
import { IDriver, LibraryItemStatus } from "@/types/docs";
  ...
  return [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        const payrollType = driver.payroll_type;
        if (!payrollType) return "-";

        return (
          <span className="capitalize">
            {payrollType}
            <Show when={payrollType === "supplier" && !!driver.supplier_name}>
              {" - "}
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return <ImagesCell images={images || []} docType="Driver" />;
      },
      enableSorting: false,
    },
    {
