...
interface DriversDataTableProps extends React.ComponentProps<"div"> {
  table: TanstackTable<IDriver>;
  actionBar?: React.ReactNode;
  loading?: boolean;
}

export function DriversDataTable({ table, actionBar, children, loading = false }: DriversDataTableProps) {
  return (
