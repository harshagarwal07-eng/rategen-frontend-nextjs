...
export type BulkFrequency = "daily" | "weekly" | "monthly" | "custom";
 ...
 *   - monthly: same day-of-month each month, skipping months that don't have
 *              that day (e.g. monthly on 31st skips Feb, Apr, Jun, Sep, Nov)
 *   - custom:  every day in range whose weekday is in `weekdays` (0=Sun..6=Sat)
 */
