...
// Lists all packages defined under the parent tour. For each package,
...
import { TourPackageDetail } from "@/types/tours";
...
export function initLinkMap(
  ...
  return Object.fromEntries(
    packages.map((p) => {
      const link = p.tour_package_addons?.find((l) => l.addon_id === addonId);
      return [
        p.id,
        {
          applies: !!link,
