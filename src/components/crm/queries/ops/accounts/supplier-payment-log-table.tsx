...
import { ExternalLink, Receipt, MoreVertical, RefreshCw } from "lucide-react";
...
type Props = {
  ...
  supplierName?: string; // Optional: if showing for a single supplier
};

export default function SupplierPaymentLogTable({ payments, loading, onPaymentUpdated, supplierName }: Props) {
