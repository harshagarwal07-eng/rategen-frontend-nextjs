...
export function KanbanToolbar({ filters, onChange }: KanbanToolbarProps) {
  const hasActiveFilters = filters.countries.length > 0 || filters.categories.length > 0;
    ...
    <div className="flex flex-wrap items-center gap-2 px-4 py-2.5 shrink-0">
      ...
      <div className="relative w-xs">
        ...
        <Input
          ...
          placeholder="Search by agent, traveler, ID..."
      ...
      {hasActiveFilters && (
        <Button
          ...
          onClick={() => onChange({ search: filters.search, countries: [], categories: [] })}
        >
