...
const ALL_STATUS_OPTIONS = [
  { value: "active", label: "Active", href: "/crm/agents/active" },
  { value: "pending", label: "Pending", href: "/crm/agents/pending" },
  { value: "inactive", label: "Inactive", href: "/crm/agents/inactive" },
  { value: "blocked", label: "Blocked", href: "/crm/agents/blocked" },
] as const;

const DEFAULT_VISIBLE_TABS = ["active", "pending", "inactive"];
const STORAGE_KEY = "crm-agent-visible-tabs";

export function AgentStatusTabs({ activeStatus, counts }: AgentStatusTabsProps) {
