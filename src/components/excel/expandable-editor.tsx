...
export function ExpandableEditor({ value, onSave, onClose, cellWidth, disabled }: ExpandableEditorProps) {
        ...
        >
          <div className="flex flex-col">
            <textarea
              ...
              placeholder={disabled ? undefined : "Enter text... (Ctrl+Enter to save, Esc to cancel)"}
            />
